...
export default function Home() {
  ...
  const featured = PRODUCTS.find((p) => p.slug === "toca-bee-preta")!;
  const grid = PRODUCTS.slice(0, 6);
  const wallet = PRODUCTS.find((p) => p.slug === "carteira-stravages")!;
    ...
    <div>
      ...
      <section className="relative isolate overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <Image
            src="/products/beanie-black-pair.jpg"
            alt=""
            fill
            priority
